<%@ Page Title="" Language="C#" MasterPageFile="~/PIHMAA.master" AutoEventWireup="true" CodeFile="Default2.aspx.cs" Inherits="Default2" %>
                ...
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body">
                        <div class="form-group">
                            <div class="input-group">
                                ...
                                <asp:TextBox ID="UserName" CssClass="form-control"  runat="server" OnTextChanged="UserName_TextChanged"></asp:TextBox>
                            </div>
                    ...
                    <div class="panel-footer panel-info">
                        <div class="row">
                            <div class="col-md-8">
                                <div class="form-group">
                                    <div>If you are not a Life Member yet! <a href="new-member-registration.aspx">Sign up here</a></div>
                                </div>
                            </div>
                            <div class="col-md-4">
